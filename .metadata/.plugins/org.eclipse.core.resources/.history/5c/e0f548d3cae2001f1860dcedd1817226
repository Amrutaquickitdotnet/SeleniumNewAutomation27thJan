...
public class Java_Example028_splitposition {
	/*
	 * This Example will give you Split Operation . If you have excel file and
	 * Firstname and LastName given and for inputing text field at the frontend ,
	 * you have to split the FirstNAme
	 */
